                                  ...
                                  <FormControl fullWidth>
                                    <Select
                                      ...
                                      renderValue={(selected) => {
                                        if (!selected) {
                                          return <em>Seleccionar ejercicio</em>;
                                        }
                                        return selected;
                                      }}
                                      sx={{ borderRadius: 2 }}
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    <Select
                      ...
                      renderValue={(selected) => {
                        if (selected.length === 0) {
                          return <em>Grupos musculares</em>;
                        }
                        return (
                    ...
                    >
                      ...
                      <MenuItem value='ardio'>Cardio</MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    >
                      <MenuItem value='Peso corporal'>Peso corporal</MenuItem>
                      ...
                      <MenuItem value='Banda de resistencia'>Banda de resistencia</MenuItem>
